...
class SeoHelper implements SeoHelperContract
{
    ...
    public function screenUsingSEOHelper()
    {
        ...
        if (defined('PROJECTS_MODULE_SCREEN_NAME')) {
            $default[] = PROJECTS_MODULE_SCREEN_NAME;
        }
        if (defined('INDUSTRIALS_MODULE_SCREEN_NAME')) {
            $default[] = INDUSTRIALS_MODULE_SCREEN_NAME;
        }
        if (defined('PRODUCTSOLUTIONS_MODULE_SCREEN_NAME')) {
            $default[] = PRODUCTSOLUTIONS_MODULE_SCREEN_NAME;
        }
        if (defined('COREEXPERTISES_MODULE_SCREEN_NAME')) {
            $default[] = COREEXPERTISES_MODULE_SCREEN_NAME;
        }
        if (defined('PRODUCT_CATEGORY_MODULE_SCREEN_NAME')) {
            $default[] = PRODUCT_CATEGORY_MODULE_SCREEN_NAME;
        }
