 ...
 * Generated for Laravel 5.4.28 on 2017-08-26.
 *
...
namespace Botble\Assets\Facades { 
    ...
    class AssetsFacade {
         ...
         * @param $assets
         * @param string $location
         * @return $this @author Tedozi Manson
         * @static 
         */ 
...
namespace Botble\Setting\Facades { 
    ...
    class SettingFacade {
        ...
        {
            return \Botble\Setting\Setting::getConfig();
        }
...
namespace Botble\Analytics\Facades { 
    ...
    class AnalyticsFacade {
         ...
         * @param array $others
         * @return \Botble\Analytics\Period|array|null 
         * @author Freek Van der Herten <freek@spatie.be>
         * @static 
         */ 
...
namespace Botble\CustomField\Facades { 
    ...
    class CustomFieldFacade {
        ...
        {
            return \Botble\CustomField\CustomField::registerRuleGroup($groupName);
        }
        ...
        {
            return \Botble\CustomField\CustomField::registerRule($group, $title, $slug, $data);
        }
        ...
        public static function render()
        {
            return \Botble\CustomField\CustomField::render();
        }
        ...
        {
            return \Botble\CustomField\CustomField::setRules($rules);
        }
         ...
         * @static 
         */ 
        public static function addRules($ruleName, $value = null)
        {
            return \Botble\CustomField\CustomField::addRules($ruleName, $value);
        }
         ...
         * @static 
         */ 
        public static function exportCustomFieldsData($screen, $object_id)
        {
            return \Botble\CustomField\CustomField::exportCustomFieldsData($screen, $object_id);
        }
...
namespace Botble\Media\Facades { 
    ...
    class RvMediaFacade {
         ...
         * @static 
         */ 
        public static function handleUpload($fileUpload, $folder_id = 0)
        {
            return \Botble\Media\RvMedia::handleUpload($fileUpload, $folder_id);
        }
...
namespace Botble\Menu\Facades { 
    ...
    class MenuFacade {
         ...
         * @static 
         */ 
        public static function recursiveSaveMenu($menu_nodes, $menu_content_id, $parent_id)
        {
            return \Botble\Menu\Menu::recursiveSaveMenu($menu_nodes, $menu_content_id, $parent_id);
        }
...
namespace Botble\SeoHelper\Facades { 
    ...
    class SeoHelperFacade {
         ...
         * @static 
         */ 
        public static function screenUsingSEOHelper()
        {
            return \Botble\SeoHelper\SeoHelper::screenUsingSEOHelper();
        }
...
namespace  { 
    ...
    class CustomField extends \Botble\CustomField\Facades\CustomFieldFacade {}
