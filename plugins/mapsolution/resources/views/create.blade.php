...
@section('content')
    {!! Form::open(['id' => 'map-form','route' => 'mapsolution.create']) !!}
        @php do_action(BASE_ACTION_CREATE_CONTENT_NOTIFICATION, MAPSOLUTION_MODULE_SCREEN_NAME, request(), null) @endphp
        <div class="row">
            <div class="col-md-9">
                <div class="main-form">
                    <div class="form-body">
                        ...
                        <div class="form-group @if ($errors->has('description')) has-error @endif">
                            ...
                            {!! Form::text('description', old('description'), ['class' => 'form-control', 'id' => 'description', 'placeholder' => trans('Description'), 'data-counter' => 120]) !!}
                        ...
                        <div class="form-group @if ($errors->has('latitude')) has-error @endif">
                            ...
                            {!! Form::text('latitude', old('latitude'), ['class' => 'form-control', 'id' => 'latitude', 'placeholder' => trans('latitude'), 'data-counter' => 120]) !!}
                        ...
                        <div class="form-group @if ($errors->has('longitude')) has-error @endif">
                            ...
                            {!! Form::text('longitude', old('longitude'), ['class' => 'form-control', 'id' => 'longitude', 'placeholder' => trans('longitude'), 'data-counter' => 120]) !!}
                ...
                @php do_action(BASE_ACTION_META_BOXES, MAPSOLUTION_MODULE_SCREEN_NAME, 'advanced') @endphp
            </div>
            <div class="col-md-3 right-sidebar">
                ...
                @php do_action(BASE_ACTION_META_BOXES, MAPSOLUTION_MODULE_SCREEN_NAME, 'top') @endphp
                @php do_action(BASE_ACTION_META_BOXES, MAPSOLUTION_MODULE_SCREEN_NAME, 'side') @endphp
            </div>
        </div>
    {!! Form::close() !!}
@stop
