...
class PostRepository extends RepositoriesAbstract implements PostInterface
{
     ...
     * @author Sang Nguyen
     */
    public function getAllPosts($limit=false, $active = true)
    {
        ...
        if(!$limit)
            ...
            $data = apply_filters(BASE_FILTER_BEFORE_GET_FRONT_PAGE_ITEM, $data, $this->model, POST_MODULE_SCREEN_NAME)->paginate($limit);
