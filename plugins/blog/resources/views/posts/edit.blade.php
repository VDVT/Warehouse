        ...
        <div class="row">
            <div class="col-md-9">
                <div class="tabbable-custom tabbable-tabdrop">
                    <ul class="nav nav-tabs">
                        ...
                        <?php //echo apply_filters(BASE_FILTER_REGISTER_CONTENT_TABS, null, POST_MODULE_SCREEN_NAME) ?>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_detail">
                            <div class="form-body">
                                ...
                                <div class="form-group @if ($errors->has('slug')) has-error @endif">
                                    {!! Form::permalink('slug', $post->slug, $post->id, route('posts.create.slug'), route('public.post.details', config('cms.slug.pattern')), url('/blog/')) !!}
                        ...
                        <?php //echo apply_filters(BASE_FILTER_REGISTER_CONTENT_TAB_INSIDE, null, POST_MODULE_SCREEN_NAME, $post) ?>
                    </div>
                </div>
            ...
            <div class="col-md-3 right-sidebar">
                ...
                <div class="widget meta-boxes">
                    ...
                    <div class="widget-body">
                        {!! Form::mediaImage('banner', $post->banner) !!}
