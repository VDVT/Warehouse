            ...
            <div class="col-md-9">
                <div class="tabbable-custom tabbable-tabdrop">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_detail">
                            <div class="form-body">
                                ...
                                <div class="form-group @if ($errors->has('slug')) has-error @endif">
                                    {!! Form::permalink('slug', old('slug'), null, route('posts.create.slug'), route('public.post.details', config('cms.slug.pattern')), url('/blog/')) !!}
                       ...
                       <?php //echo apply_filters(BASE_FILTER_REGISTER_CONTENT_TAB_INSIDE, null, POST_MODULE_SCREEN_NAME, null) ?>
                    </div>
                </div>
