                                        ...
                                        <div class="box_mega d-flex flex-wrap align-items-center justify-content-between">
                                            <div class="box">
                                                ...
                                                <nav class="nav d-flex flex-wrap">
                                                    ...
                                                    ?>
                                                        <a class="nav-link col-md-6" href="{{ route('public.product-solution.details', $product_solution->slug) }}" data="<?php echo $product_solution->image; ?>">{{ $product_solution->name }}</a>
                                                    <?php } ?>
                                                </nav>
                                            </div>
                                        ...
                                        <div class="box_mega d-flex  flex-wrap align-items-center justify-content-between">
                                            <div class="box">
                                                ...
                                                <nav class="nav d-flex flex-wrap">
                                                    ...
                                                    ?>
                                                        <a class="nav-link col-md-6" href="{{ route('public.industrial.details', $industrial->slug) }}" data="<?php echo $industrial->image; ?>">{{ $industrial->name }}</a>
                                                    <?php } ?>
                                        ...
                                        <div class="box_mega d-flex  flex-wrap align-items-center justify-content-between">
                                            <div class="box">
                                                ...
                                                <nav class="nav d-flex flex-wrap">
                                                    ...
                                                    ?>
                                                        <a class="nav-link col-md-6" href="{{ route('public.core-expertise.details', $core_expertise->slug) }}" data="<?php echo $core_expertise->image; ?>">{{ $name }}</a>
                                                    <?php } ?>
                                                    <!-- <a class="nav-link col-6" href="{{ route('public.industrial.details', 'anchors') }}" data="<?php echo Theme::asset()->url('images/megamenu.png'); ?>">Warehousing</a>
                                                    <a class="nav-link col-6" href="{{ route('public.industrial.details', 'anchors') }}" data="<?php echo Theme::asset()->url('images/megamenu.png'); ?>">Wholesaler</a>
                                                    <a class="nav-link col-6" href="{{ route('public.industrial.details', 'anchors') }}" data="<?php echo Theme::asset()->url('images/megamenu.png'); ?>">3PL</a>
                                        ...
                                        <div class="box_mega">
                                            <div class="box box-resource">
                                                <nav class="nav d-block">
                                                    ...
                                                    <a class="nav-link" href="{{ route('public.page.career') }}">Career Opportunities</a>
                                                    <a class="nav-link" href="{{ route('public.page.donation') }}">Donation Request</a>
                                                    <a class="nav-link" href="{{ route('public.page.project-completion') }}">Project Completion</a>
                                                </nav>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <li class="d-sm-block d-md-none d-lg-none d-xl-none">
                                    <div class="box-hotline-menu d-flex align-items-center justify-content-center">
                                        <div class="box-content text-center">
                                            <p class="hotline font-weight-bold"><i class="fa fa-phone" aria-hidden="true"></i> {{ theme_option('phone') }}</p>
                                            <a class="nav-link btn-effect btn-contact" href="{{ route('public.page.contactaccountmanager') }}">Get A Quote</a>
                                        </div>
                                    </div>
                                </li>
                            </ul>
